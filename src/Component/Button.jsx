...
const Button = ({ children }) => {
    return (
        <div>
            <a href="#_" className="inline-flex items-center justify-center w-full px-6 py-2 mb-2 text-lg text-white bg-blue-800 hover:bg-[#061E43] duration-500 rounded-md sm:w-auto sm:mb-0" data-primary="green-400" data-rounded="rounded-2xl" data-primary-reset="{}">
                {children}
