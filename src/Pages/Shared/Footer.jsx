...
const Footer = () => {
    return (
        <div>
          ...
          <footer
  className="bg-[#061E43] text-center text-white dark:bg-white dark:text-neutral-200 lg:text-left">
  <div
  ...
  <div className="bg-[#061E43] p-6 text-center dark:bg-neutral-700">
